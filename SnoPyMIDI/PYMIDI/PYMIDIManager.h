...
extern NSString* PYMIDIObjectAdded;
extern NSString* PYMIDIObjectRemoved;
extern NSString* PYMIDISetupChanged;

#pragma mark NOTIFICATION USER DICT KEYS

extern NSString* PYMIDIAddedRemovedObject;
